...
public class ConfirmPasswordFailDialog extends DialogFragment {
    public ConfirmPasswordFailDialog() {
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton("확인", null)
                .setItems(R.array.ConfirmPasswordFail, new DialogInterface.OnClickListener() {
                    @Override
