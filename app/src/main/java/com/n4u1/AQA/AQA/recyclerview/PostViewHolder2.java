...
public class PostViewHolder2 extends RecyclerView.ViewHolder implements AnimateViewHolder {

    public ImageView imageView_postImg_1, imageView_postImg_0, imageView_postImg_2, imageView_like,
            imageView_share, imageView_hitCount, imageView_state, imageView_userClass, imageView_reply;
