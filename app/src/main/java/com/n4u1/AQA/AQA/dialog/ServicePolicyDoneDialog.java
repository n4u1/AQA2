...
public class ServicePolicyDoneDialog extends DialogFragment {
    public ServicePolicyDoneDialog() {
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton("확인", null)
                .setItems(R.array.ServicePolicyDone, new DialogInterface.OnClickListener() {
                    @Override
