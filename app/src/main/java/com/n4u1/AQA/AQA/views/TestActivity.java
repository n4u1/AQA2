...
ToDo
###################################################################################################################################################
공유하기 버튼 구현 필요 / 댓글 or 게시글 삭제 및 수정 기능 필요 / 동영상을 어떻게 하지.... / 비밀번호 변경 / 비밀번호 찾기 /
###################################################################################################################################################
친구추가 기능? / 채팅 기능? / 사진 2개일경우 자동으로 단일 투표로 /  투표수에 따른 알람 /
###################################################################################################################################################
###################################################################################################################################################
###################################################################################################################################################
개인정보보호처리 / 사진 2개일경우 자동으로 단일 투표로 / 리플달때만 리플수 변경됨 / SharedPreferences 자동로그인 / 검색결과창, 마이업로드에 더보기 기능?
###################################################################################################################################################
mineActivity 에서 이메일 항목 n 글자 이상일경우 ... 표시 / 로그인>홈 스플래시 액티비티 / uploadContentsActivity 제목부분 글자 밀림현상 / 내가 올린게 아니어도 알람 받고싶을수있자나?
###################################################################################################################################################
userPoint(userClass) 점수 카운팅, 점수 업로딩 / 광고ID / 광고 삽입 / 공유 인증 페이지 / 로그아웃 / 회원 탈퇴
###################################################################################################################################################
