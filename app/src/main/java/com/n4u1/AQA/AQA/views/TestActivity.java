...
###################################################################################################################################################
 자료출처 / 둘러보기 / 공지사항, AQA..., / 개인정보보호방침 다시 검토 / 이용약관 다시 검토 / 로그인과정(마지막)에서 개인정보관한사항넣기(체크박스)
###################################################################################################################################################
사용자 탈퇴하면 PostAdapter userClass가져올때 uid없어서 null 떨어짐 /
###################################################################################################################################################
###################################################################################################################################################
###################################################################################################################################################
###################################################################################################################################################
둘러보기 예외처리 / 둘러보기(정상)접속시 처음 사용자 안내팝업(투표방법) /  기기 초기화(guid) / 딥링크 확인 / 공지사항
###################################################################################################################################################
