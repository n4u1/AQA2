...
###################################################################################################################################################
게시글 삭제한다음에 오는 액티비티에 삭제된 게시글 남아있음 / 컨텐츠삭제시 스토리지도 삭제 / 더해지다가 1000점 되면?? / 차트색깔.. /
###################################################################################################################################################
관리자 페이지 : 이벤트,공지사항업로드,각종조회되도록,런칭후 1년뒤 미사용자 체크후 개인정보 별도 보관필요
###################################################################################################################################################
###################################################################################################################################################
###################################################################################################################################################
광고 추가 / 공유인증 이벤트 진행방식? / 마지막에 구글 그..광고 아이디 변경해야함. / 이메일변경 UI 수정 / AQA는... 수정 / 순위투표선택후 2개 이미지면 토스트를 하나 띄울까?
###################################################################################################################################################
###################################################################################################################################################
###################################################################################################################################################
###################################################################################################################################################
